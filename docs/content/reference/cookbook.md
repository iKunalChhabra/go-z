...
Copy-paste recipes for common go-z patterns.
...
var envSchema = z.Object(z.Shape{
...
```go
var webhooks = z.DiscriminatedUnion("type", []z.AnySchemaLike{
    z.Object(z.Shape{
