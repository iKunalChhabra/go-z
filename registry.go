...
// (Zod's GlobalMeta / JSONSchemaMeta). Callers may also use map[string]any.
...
// Registry maps schemas to metadata, porting $ZodRegistry. Schemas are keyed
...
// GlobalRegistry is the process-wide metadata registry (Zod's globalRegistry).
