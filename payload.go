...
// startIndex on. Mirrors Zod's util.aborted: any issue whose continue flag is
...
// explicitlyAborted mirrors Zod's util.explicitlyAborted: only issues with
...
// issues, exactly like Zod's `path.unshift(key)`.
