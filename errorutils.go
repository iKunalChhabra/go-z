...
// FlattenedError mirrors Zod's flattenError output (string messages).
...
// ErrorTree mirrors Zod's treeifyError output (string messages).
...
func Flatten(err *ZodError) FlattenedError {
...
func FlattenMap[U any](err *ZodError, mapper func(Issue) U) FlattenedErrorU[U] {
...
func Format(err *ZodError) map[string]any {
...
// invalid_key / invalid_element issues are traversed like Zod.
func FormatMap[U any](err *ZodError, mapper func(Issue) U) map[string]any {
...
func Treeify(err *ZodError) *ErrorTree {
...
func TreeifyMap[U any](err *ZodError, mapper func(Issue) U) *ErrorTreeU[U] {
...
// "✖ message\n  → at path".
func Prettify(err *ZodError) string {
