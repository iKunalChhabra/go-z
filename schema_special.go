...
// UndefinedSchema accepts only Missing (Zod undefined) — z.undefined().
...
// VoidSchema accepts only Missing — in Zod v4, z.void() is equivalent to
...
// tokens (case-insensitive): true/false, yes/no, 1/0, on/off (and Zod extras
